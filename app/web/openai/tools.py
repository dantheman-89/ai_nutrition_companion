...
PROFILE_TOOL_DEFINITION = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "target_weight_timeframe": {"type": "number", "description": "Number of weeks to reach target weight"},
            "culture":       {"type": "string"},
            "food_preferences": {
            "type": "array",
            "items": {"type": "string"},
...
async def update_profile_json(user_data_dir, fields_to_update: dict):
    ...
    field_mapping = {
        ...
        "target_weight": "goals.weight_goals.target_weight_kg",
        "target_weight_timeframe": "goals.weight_goals.goal_timeframe_weeks",
